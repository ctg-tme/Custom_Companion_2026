...
See [`installer/README.md`](../installer/README.md) for local commands and ADR 0002 through ADR 0005 plus ADR 0008 and ADR 0009 for source selection, credentials, Companion Device Identity Confirmation, forward-only installation, and Installer Parent Room administration decisions.
