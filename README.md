...
See `installer/README.md` for local commands and ADR 0002 through ADR 0005 for source selection, credentials, Companion Device Identity Confirmation, and forward-only installation decisions.
