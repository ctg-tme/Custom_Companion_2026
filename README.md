...
| Paired calling policy notice | `xapi.Command.UserInterface.Message.Alert.Display({ Duration: 15, ... })` and `.Alert.Clear()` | None; the Companion Device Call Synchronization controller owns the matching Infoblock 3 timer |
