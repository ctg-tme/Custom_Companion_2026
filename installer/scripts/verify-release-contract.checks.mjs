...
const contract = {
  ...
  InstallerParentRegistrationProgressMessage: 'Companion Installer Parent Room Registration progress',
  ...
  InstallerParentDeregistrationProgressMessage: 'Companion Installer Parent Room Deregistration progress',
